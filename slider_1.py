...
##        self.pushButton_2.clicked.connect(lambda: self.pressedOffButton())
        self.pushButton.clicked.connect(lambda: self.btn_clk(self.pushButton, 'Clear'))
        self.pushButton_2.clicked.connect(lambda: self.btn_clk(self.pushButton_2, 'Print'))
